...
本仓库精选 [Agent Skills](https://agentskills.io)，用于在 [Base](https://base.org) 上构建 AI 智能体。这些 skills 让智能体能够连接 Base 基础设施、管理钱包、发行代币、参与智能体市场、与 DeFi 协议交互等。
...
| [alchemy](skills/alchemy/) | 面向智能体的区块链数据 API：Node API、Token API、Webhooks，x402 按量计费。 | [https://agents.alchemy.com/](https://agents.alchemy.com/) |
...
| [privy-agentic-wallets](skills/privy-agentic-wallets/) | 用 Privy 创建由 AI 智能体自主控制、带策略约束的加密钱包。 | [https://github.com/privy-io/privy-agentic-wallets-skill](https://github.com/privy-io/privy-agentic-wallets-skill) |
...
| Skill | Description | Original Link |
| ----- | ----------- | ------------- |
| [virtual-protocol-acp](skills/virtual-protocol-acp/) | Agent Commerce Protocol CLI：智能体钱包、市场、代币发行、卖家运行时、Twitter/X 集成。 | [https://github.com/Virtual-Protocol/openclaw-acp](https://github.com/Virtual-Protocol/openclaw-acp) |
| [moltlaunch](skills/moltlaunch/) | 链上协作：注册、接单、积累声誉、雇佣智能体，报价制任务，Base 上 trustless 托管。 | [https://moltlaunch.com/skill.md](https://moltlaunch.com/skill.md) |
| [daydreams-taskmarket](skills/daydreams-taskmarket/) | 开放任务市场，智能体赚取 USDC，X402 trustless 支付，Base 主网 ERC-8004 身份。 | [https://market.daydreams.systems/skill.md](https://market.daydreams.systems/skill.md) |
...
| [claunch](skills/claunch/) | 通过 Bankr 在 Base 上免费发行代币，智能体赚取交易手续费。 | [https://clawn.ch/skill.md](https://clawn.ch/skill.md) |
...
| [dx-terminal-pro](skills/dx-terminal-pro/) | 在 DX Terminal Pro 上管理自主 meme 币交易智能体。 | [https://github.com/ProjectDXAI/dx-terminal-pro-skill](https://github.com/ProjectDXAI/dx-terminal-pro-skill) |
...
| [agentmail](skills/agentmail/) | 面向智能体的 API 优先邮箱：创建收件箱、收发邮件、webhooks、智能体身份。 | [https://clawhub.ai/adboio/agentmail](https://clawhub.ai/adboio/agentmail) |
| [xmtp](skills/xmtp/) | 人与智能体之间的安全去中心化消息，XMTP SDK、智能体身份。 | [https://github.com/xmtp/skills](https://github.com/xmtp/skills) |
...
| Skill | Description | Original Link |
| ----- | ----------- | ------------- |
| [clawrouter](skills/clawrouter/) | 面向智能体的 LLM 路由，按需选模型与价格，15 维评分，41+ 模型，零 API key。 | [https://github.com/BlockRunAI/ClawRouter](https://github.com/BlockRunAI/ClawRouter) |
| [heurist-mesh](skills/heurist-mesh/) | 通过 30+ 专业 AI 智能体获取 Web3/加密情报：分析、代币数据、钱包分析。 | [https://github.com/heurist-network/heurist-mesh-skill](https://github.com/heurist-network/heurist-mesh-skill) |
...
| Skill | Description | Original Link |
| ----- | ----------- | ------------- |
| [remix](skills/remix/) | 通过 API 驱动的智能体工作流在 Remix 上构建游戏的最佳实践。 | [https://github.com/farworld-labs/remix-skills](https://github.com/farworld-labs/remix-skills) |
| [basebario-agentarcade](skills/basebario-agentarcade/) | AI 智能体游戏平台，在 Base 上构建并发布游戏为 NFT，Baes SDK。 | [https://aa.baes.app/_skill/SKILL.md](https://aa.baes.app/_skill/SKILL.md) |
| [basebario-fxclaw](skills/basebario-fxclaw/) | AI 智能体用 p5.js 创作生成艺术的社交平台。 | [https://fxclaw.xyz/SKILL.md](https://fxclaw.xyz/SKILL.md) |
