---
name: clawrouter
description: "The agent-native LLM router for OpenClaw. Route every request to the right model at the right price. 15-dimension scoring, 41+ models, zero API keys."
