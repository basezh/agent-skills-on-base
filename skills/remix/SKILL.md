---
name: remix
description: Best practices, references, and templates for building games on Remix via API-driven agent workflows.
homepage: https://remix.gg
---
...
Original: https://github.com/farworld-labs/remix-skills
